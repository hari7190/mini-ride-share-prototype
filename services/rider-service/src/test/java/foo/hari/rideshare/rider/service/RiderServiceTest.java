package foo.hari.rideshare.rider.service;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import foo.hari.rideshare.rider.dto.RideRequestDTO;
import foo.hari.rideshare.rider.dto.RideRequestedEvent;
import foo.hari.rideshare.rider.entity.Ride;
import foo.hari.rideshare.rider.entity.RideStatus;
import foo.hari.rideshare.rider.repository.RideRepository;
...
class RiderServiceTest {
    ...
    void setUp() {
        ...
        ReflectionTestUtils.setField(riderService, "rideRequestedEventType",
                "foo.hari.rideshare.rider.dto.RideRequestedEventDTO");
    ...
    void createRideRequest_savesTripAndPublishesEvent() throws Exception {
        ...
        assertEquals("foo.hari.rideshare.rider.dto.RideRequestedEventDTO",
