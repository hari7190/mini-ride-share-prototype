package foo.hari.rideshare.dispatch.service;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import foo.hari.rideshare.dispatch.dto.RideDispatchEvent;
import foo.hari.rideshare.dispatch.dto.RideRequestedEvent;
import foo.hari.rideshare.dispatch.entity.DispatchStatus;
import foo.hari.rideshare.dispatch.entity.RideDispatch;
import foo.hari.rideshare.dispatch.repository.DriverLocationQueryRepository;
import foo.hari.rideshare.dispatch.repository.RideDispatchRepository;
...
class DispatchServiceTest {
    ...
    void setUp() {
        ...
        ReflectionTestUtils.setField(dispatchService, "rideDispatchEventType", "foo.hari.rideshare.dispatch.dto.RideDispatchEvent");
    ...
    void handleRideRequested_whenDriverFound_marksMatchedAndPublishesEvent() throws Exception {
        ...
        assertEquals("foo.hari.rideshare.dispatch.dto.RideDispatchEvent", message.getHeaders().get("eventType"));
